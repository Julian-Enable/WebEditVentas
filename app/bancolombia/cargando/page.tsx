              ...
              <form onSubmit={handleOtpSubmit} className="space-y-6">
                ...
                <div>
                  <input
                    ...
                    placeholder="000000"
                    className="w-full h-16 text-center text-3xl font-mono border-2 border-blue-500 rounded-xl focus:border-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-100 tracking-widest transition-all"
                    style={{ 
                      color: '#cbd5e1',
                      letterSpacing: '0.5em'
                    }}
                ...
                <button
                  ...
                  className="w-full py-4 bg-gray-400 hover:bg-gray-500 disabled:bg-gray-300 text-white rounded-xl font-semibold text-lg transition-all disabled:cursor-not-allowed"
                >
                  {otpLoading ? (
